...
@Slf4j
public class Consumer2ForRebalancingTest {

    private final Properties consumerConfig;

    public Consumer2ForRebalancingTest(Properties consumerConfig) {
    ...
    public void start(String topic) {
        ...
        kafkaConsumer.subscribe(Collections.singleton(topic), new ConsumerRebalanceListener() {
            ...
            public void onPartitionsRevoked(Collection<TopicPartition> partitions) {
                if(partitions.size() > 0) {
                    ...
                    log.warn("[C2] onPartitionsRevoked: {}", sb);
                } else {
                    log.warn("[C2] onPartitionsRevoked: NOTHING");
                }
            }
            ...
            public void onPartitionsAssigned(Collection<TopicPartition> partitions) {
                if(partitions.size() > 0) {
                    ...
                    log.warn("[C2] onPartitionsAssigned: {}", sb);
                } else {
                    log.warn("[C2] onPartitionsAssigned: NOTHING");
                }
            }
        });
        ...
        while(true) {
            ...
            for (ConsumerRecord<String, String> consumerRecord : consumerRecords) {
                ...
                log.info("[C2ForRebalancing] Topic: {}, Partitions: {}, Offset: {}, Key: {}, Value: {}, Last Committed Offset: {}",
